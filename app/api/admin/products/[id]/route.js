...
export async function PUT(request, { params }) {
  ...
  const p = parsed.data;
  try {
    const result = await getPool().query(`UPDATE products SET slug=$1, name=$2, description=$3, category=$4, price=$5, compare_at_price=$6, image_url=$7, badge=$8, stock=$9, is_featured=$10, is_new=$11, is_active=$12
