...
export function parseProduct(body) {
  ...
  return { data: { name, description, category, imageUrl, price, compareAtPrice: parsedVariants.length ? null : compareAtPrice, stock, variants: parsedVariants, badge: badge || null, featured: body.featured === true, newest: body.newest === true, active: body.active !== false } };
}
